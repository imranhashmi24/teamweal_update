...
class FinancialInvestmentController extends Controller
{

    public $model = FinancialInvestment::class;
    public $searchable = ['title', 'title_ar'];
    public $view = "admin.financial_investments";
    public $route = "admin.financial_investments";
    public $redirect = "admin.financial_investments";
    public $notify = "Financial Investment";
    public $file_path = "financial_investment";
