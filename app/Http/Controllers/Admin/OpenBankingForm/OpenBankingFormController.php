...
class OpenBankingFormController extends Controller
{

    public $model = OpenBankingForm::class;
    public $searchable = ['title', 'title_ar'];
    public $view = "admin.open_banking_forms";
    public $route = "admin.open_banking_forms";
    public $redirect = "admin.open_banking_forms";
    public $notify = "OpenBankingForm";
