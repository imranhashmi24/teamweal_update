...
namespace App\Http\Controllers\Admin\OpenBankingForm;

use Illuminate\Http\Request;
use App\Models\OpenBankingFormForm;
use App\Http\Controllers\Controller;

class OpenBankingFormFormController extends Controller
{

    public $model = OpenBankingFormForm::class;
    public $searchable = ['name', 'name_ar'];
    public $view = "admin.open_banking_forms.forms";
    public $route = "admin.open_banking_forms.forms";
    public $redirect = "admin.open_banking_forms.forms";
    public $notify = "OpenBankingFormForm";
    public $file_path = "open_banking_forms";
