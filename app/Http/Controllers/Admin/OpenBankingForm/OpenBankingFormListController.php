...
class OpenBankingFormListController extends Controller
{

    public $model = OpenBankingFormList::class;
    public $searchable = ['title', 'title_ar'];
    public $view = "admin.open_banking_forms.lists";
    public $route = "admin.open_banking_forms.lists";
    public $redirect = "admin.open_banking_forms.lists";
    public $notify = "OpenBankingFormList";
