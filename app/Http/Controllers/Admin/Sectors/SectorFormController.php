...
class SectorFormController extends Controller
{

    public $model = SectorForm::class;
    public $searchable = ['name', 'name_ar'];
    public $view = "admin.sectors.forms";
    public $route = "admin.sectors.forms";
    public $redirect = "admin.sectors.forms";
    public $notify = "Sector Form";
    public $file_path = "sector_form";
