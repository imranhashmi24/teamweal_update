...
use App\Models\SettlementRequestList;
use App\Http\Controllers\Controller;

class SettlementRequestListController extends Controller
{

    public $model = SettlementRequestList::class;
    public $searchable = ['title', 'title_ar'];
    public $view = "admin.settlement_requests.lists";
    public $route = "admin.settlement_requests.lists";
    public $redirect = "admin.settlement_requests.lists";
    public $notify = "SettlementRequestList";
