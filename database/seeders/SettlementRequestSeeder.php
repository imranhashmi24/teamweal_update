...
class SettlementRequestSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        SettlementRequest::truncate();
        SettlementRequestList::truncate();
        SettlementRequestForm::truncate();

        DB::statement('SET FOREIGN_KEY_CHECKS=1;');


        foreach ($datas as $os) {
            $ds = new SettlementRequest();
            ...
            if (isset($os['lists'])) {
                foreach ($os['lists'] as $list) {
                    $oslist = new SettlementRequestList();
            ...
            if (isset($os['forms'])) {
                foreach ($os['forms'] as $form) {
                    $osform = new SettlementRequestForm();
