@extends('admin.layouts.app', ['title' => 'Edit Event News'])
@section('panel')
<form action="{{ route('admin.event_news.update', @$event->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
                ...
                <div class="mb-3 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <x-image-uploader class="w-100" name="image" type="event_news"
                            imagePath="{{ getImage(getFilePath('event_news') . '/' . @$event->image, getFileSize('event_news')) }}"
                        />
                    </div>
                </div>
            </div>
