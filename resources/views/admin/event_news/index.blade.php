@extends('admin.layouts.app', ['title' => 'Event News'])
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="gap-2 d-flex align-items-center">
                                                ...
                                                <a
                                                    href="{{ route('admin.event_news.show', $event->id) }}">{{ strLimit($event->title, 15) }}</a>
                                            </div>
                                        </td>
                                        <td>
                                            <a
                                                href="{{ route('admin.event_news.show', $event->id) }}">{{ strLimit($event->title_ar, 15) }}</a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="{{ route('admin.event_news.edit', $event->id) }}">
                                                            <i class="bi bi-pencil me-1"></i> @lang('Edit')
                                                        </a>
                                                    </li>
                                                    <li><a href="{{ route('admin.event_news.show', $event->id) }}"> <i
...
@push('breadcrumb-plugins')
    <div class="flex-wrap gap-3 d-flex">
        ...
        <a href="{{ route('admin.event_news.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i>@lang('Add New')</a>
    </div>
@endpush
