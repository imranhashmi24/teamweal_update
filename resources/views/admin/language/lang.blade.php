@extends('admin.layouts.app', ['title' => 'Language Manager'])
@section('panel')
    <div class="row">
                                ...
                                @forelse ($languages as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge bg-warning">@lang('Selectable')</span>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="btn-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModalLabel"> @lang('Add New Language')</h5>
                ...
                <form class="form-horizontal" method="post" action="{{ route('admin.language.manage.store') }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 row form-group">
                            <label class="form-label">@lang('Language Name')</label>
                            <div class="col-sm-12">
                        ...
                        <div class="mb-3 row form-group">
                            <div class="col-md-12">
                                <label class="form-label" for="inputName">@lang('Default Language')</label>
    ...
    <div class="modal fade" id="getLangModal" tabindex="-1" role="dialog" aria-labelledby="getLangModalLabel"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="getLangModalLabel">@lang('Language Keywords')</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <p class="mb-3 text--primary">@lang('You can import these keywords from the translate page of any language as well.')</p>
...
@push('breadcrumb-plugins')
    <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
        data-bs-target="#createModal"><i class="las la-plus me-2"></i>@lang('Add New')</button>
    <button type="button" class="btn btn-sm btn-outline-success keyBtn" data-bs-toggle="modal"
        data-bs-target="#getLangModal"><i class="las la-code me-2"></i>@lang('Language Keywords')</button>
@endpush
