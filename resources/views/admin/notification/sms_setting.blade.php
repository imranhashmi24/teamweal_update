@extends('admin.layouts.app',['title'=> 'SMS Notification Settings'])
@section('panel')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        <div class="mb-3 form-group">
                            <label class="form-label">@lang('Sms Send Method')</label>
                        ...
                        <div class="mt-4 row d-none configForm" id="clickatell">
                            <div class="col-md-12">
                        ...
                        <div class="mt-4 row d-none configForm" id="infobip">
                            <div class="col-md-12">
                        ...
                        <div class="mt-4 row d-none configForm" id="messageBird">
                            <div class="col-md-12">
                        ...
                        <div class="mt-4 row d-none configForm" id="nexmo">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 form-group">
                                    <label class="form-label">@lang('API Secret') </label>
                        ...
                        <div class="mt-4 row d-none configForm" id="smsBroadcast">
                            <div class="col-md-12">
                        ...
                        <div class="mt-4 row d-none configForm" id="twilio">
                            <div class="col-md-12">
                                <h6 class="mb-2">@lang('Twilio Configuration')</h6>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3 form-group">
                                    <label class="form-label">@lang('Account SID') </label>
                        ...
                        <div class="mt-4 row d-none configForm" id="textMagic">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 form-group">
                                    <label class="form-label">@lang('Apiv2 Key') </label>
                        ...
                        <div class="mt-4 row d-none configForm" id="custom">
                            <div class="col-md-12">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <select name="custom_api_method" class="method-select form-control">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3 table-responsive table-responsive--sm">
                                        <table class="table">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 card border-dark">
                                        <div class="card-header bg-dark d-flex justify-content-between">
                                            <h5 class="text-white">@lang('Headers')</h5>
                                            <button type="button" class="float-right btn btn-sm btn-outline-light addHeader"><i class="la la-fw la-plus"></i>@lang('Add') </button>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 card border-dark">
                                        <div class="card-header bg-dark d-flex justify-content-between">
                                            ...
                                            <button type="button" class="float-right btn btn-sm btn-outline-light addBody"><i class="la la-fw la-plus"></i>@lang('Add') </button>
                                        </div>
                                        <div class="card-body">
