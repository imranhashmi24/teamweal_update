                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="{{ route($route.'.edit', ['id' => $list->id]) }}" class="btn btn-primary">
                                                    ...
                                                    <li>
                                                        <button type="button" 
                                                                ...
                                                                data-question="@lang('Are you sure to delete this categoty list?')"
                                                                data-action="{{ route($route.'.delete', ['id' => $list->id]) }}">
...
@push('breadcrumb-plugins')
    <div class="flex-wrap gap-3 d-flex justify-content-between mb-3">
        ...
        <div>
            <a href="{{ route($route.'.create') }}" class="btn btn-primary cuModalBtn" data-modal_title="@lang('Add Our Category List')"><i
