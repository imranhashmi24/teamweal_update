                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="{{ route($route.'.edit', ['service_id' => $form->service_id , 'id' => $form->id]) }}" class="btn btn-primary">
                                                    ...
                                                    <li>
                                                        <button type="button" 
                                                                ...
                                                                data-action="{{ route($route.'.delete', ['service_id' => $form->service_id , 'id' => $form->id]) }}">
...
@push('breadcrumb-plugins')
    <div class="flex-wrap gap-3 d-flex justify-content-between mb-3">
        ...
        <div>
            <a href="{{ route($route.'.create', $service_id) }}" class="btn btn-primary cuModalBtn" data-modal_title="@lang('Add Our Service Form')"><i
