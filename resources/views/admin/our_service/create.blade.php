@extends('admin.layouts.app', ['title' => __('Add Our Service')])
@section('panel')
    <div class="card">
        <div class="card-header">
            <h4 class="card-title text-capitalize">@lang('Add New Our Service')
                <a href="{{ route('admin.our_service.index') }}" class="btn btn-primary float-end">@lang('Back')</a>
            </h4>
        </div>
        <div class="card-body">
                <form action="{{ route('admin.our_service.store') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                       ...
                       <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <div class="mb-1">
                                ...
                                <div class="invalid-feedback">
                                    @lang('The Image field is required. ' . getFileSize('our_service'))
                                </div>
                            </div>
                        </div>
