@extends('admin.layouts.app', ['title' => __('service form edit')])
@section('panel')
    <div class="card">
        <div class="card-header">
            <h4 class="card-title text-capitalize">@lang('Edit Our Service Form')
                <a href="{{ route('admin.our_service.forms.index', $service_id) }}" class="btn btn-primary float-end">@lang('Back')</a>
            </h4>
        </div>
        <div class="card-body">
                <form action="{{ route('admin.our_service.forms.update', ['service_id' => $service_id , 'id' => $form->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="mt-2 text-center col-12">
                            <a href="{{ route('admin.our_service.forms.index', $service_id) }}" class="btn btn-danger">@lang('Cancel')</a>
