@extends('admin.layouts.app',['title'=> 'Notification to Verified Users'])
@section('panel')
<div class="card">
    <form class="notify-form" action="">
            ...
            <div class="row">
                <div class="mb-3 col-md-12">
                    <div class="form-group">
                        <label class="form-label">@lang('Being Sent') </label>
                ...
                <div class="mb-3 col-md-12">
                    <div class="row">
                        <div class="col-md-4 start-from-col">
                            <div class="form-group">
                                <label class="form-label">@lang('Start Form') </label>
                        ...
                        <div class="col-md-4 per-batch-col">
                            <div class="form-group">
                                <label class="form-label">@lang('Per Batch') </label>
                                <div class="input-group">
                        ...
                        <div class="col-md-4 cooling-period-col">
                            <div class="form-group">
                                <label class="form-label">@lang('Cooling Period') </label>
                                <div class="input-group">
        ...
        <div class="card-footer">
            <button class="btn w-100 btn-primary me-2" type="submit">@lang('Submit')</button>
        </div>
    </form>
</div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center text--danger dontCloseWarning">@lang('Don\'t close or refresh the window till finish.')</h4>
                    ...
                    <div class="finalStatistics d-none">
                        <div class="text-center mail-icon text--success fw-bold">
                    ...
                    <h4 class="text-center text--primary remainingTime d-none"></h4>

                    <div class="mt-3">
                        <p class="mb-2 text-center sentStatistics">@lang('Email sent') <span class="startFrom">0</span> @lang('to') <span class="sent">-</span> @lang('users')
                        </p>
...
@push('breadcrumb-plugins')
    <span class="text-primary">@lang('Notification will send via') @if ($general->en)
            <span class="badge bg-success">@lang('Email')</span>
            @endif @if ($general->sn)
                <span class="badge bg-success">@lang('SMS')</span>
            @endif
    </span>
@endpush
    ...
    <script>
        (function($) {
            ...
            $('.notify-form').on('submit', function(e) {
                ...
                if ({{ $users }} <= 0) {
                    notify('error', `@lang'Users not found')`);
                    return false;
                }
                if (!coolingTime) {
