@extends('admin.layouts.app',['title'=> 'Send Notification to '. $user->username])
...
@push('breadcrumb-plugins')
    <span class="text--primary">@lang('Notification will send via ') @if(gs('en')) <span class="badge badge--warning">@lang('Email')</span> @endif @if(gs('sn')) <span class="badge badge--warning">@lang('SMS')</span> @endif</span>
@endpush
