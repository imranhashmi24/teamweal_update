            ...
            @csrf
              <div class="modal-body">
                ...
                <div class="mb-3 form-group">
                    <label class="form-label">@lang('Form Type')</label>
                ...
                <div class="mb-3 form-group">
                    <label class="form-label">@lang('Is Required')</label>
                ...
                <div class="mb-3 form-group">
                    <label class="form-label">@lang('Form Label')</label>
                    <input type="text" name="form_label" class="form-control" required>
                </div>
                <div class="mb-3 form-group extra_area">
