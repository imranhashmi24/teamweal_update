                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:24px;line-height:42px;font-weight:400;font-style:normal;color:#282828;text-decoration:none;letter-spacing:0px;">
                                    <div>
                                        <img src="{{ asset('assets/web/img/logo/logo.png') }}" alt="">
                                    </div>
                                        <div>
                                            <p>A new reply from {{ env('APP_NAME') }}</p>
                                        </div>
                                                    ...
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="center-text container-padding" align="left"
                                                                ...
                                                                <div>
                                                                    {{ Str::limit($msg_data->message, 200, '...') }}
                                                                </div>
                                                    ...
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="center-text container-padding" align="left"
                                                                ...
                                                                <div>
                                                                    {!! $msg_data->reply ?? 'no content' !!}
                                                                </div>

                                                                <div style="text-align: center; margin-top: 40px">
                                                                    <a target="_blank"
                                                                       href="{{ route('ua.messages.show', $msg_data) }}"
                                                                       style="
                                                                    border: none;
                                                                    outline: none;
                                                                    ...
                                                                    color: white;
                                                                    padding:8px 15px;
                                                                    border-radius: 10px">View
                                                                        Message In Website</a>
                                                                </div>
                                                                ...
                                                                @if (getSetVal('instagram') != '')
                                                                    <table border="0" align="center" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td width="10"></td>
                                                                            <td align="center">
                                                                                <a href="{{ getSetVal('instagram') }}"><img
                                                                                         style="width:36px;border:0px;display: inline!important;"
                                                                ...
                                                                @if (getSetVal('pinterest') != '')
                                                                    <table border="0" align="center" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td width="10"></td>
                                                                            <td align="center">
                                                                                <a href="{{ getSetVal('pinterest') }}"><img
                                                                                         style="width:36px;border:0px;display: inline!important;"
