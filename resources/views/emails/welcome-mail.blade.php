...
<head>
    ...
    <title>{{ __('mail.welcome.Welcome Title') }} | {{ config('app.name') }}</title>
...
<body style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;"
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:776px;">
        <tr>
            <!-- Outer Table -->
            <td align="center" bgcolor="#f0f0f0" data-composer>
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%"
                    ...
                    <!-- lotus-header-1 -->
                    <tr>
                        <td align="center" bgcolor="#ff00c4" class="container-padding">
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="center" class="center-text">
                                        <img style="width:190px;border:0px;display: inline!important; filter:invert(1);"
                                             src="{{ asset('assets/img/emails/email-logo.png') }}" width="190" border="0"
                                             alt="intro">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <div>
                                            {{ __('mail.welcome.Welcome', ['name' => $user->name]) }}
                                        </div>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <div>
                                            {{ __('mail.welcome.Welcome Paragraph') }}
                                        </div>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center"
                                            ...
                                            <tr>
                                                ...
                                                <![endif]-->
                                                    ...
                                                    <a href="{{ config('mail.welcome.welcome_url') }}" target="_blank"
                                                       style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:white;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;background: #8a0ca0;border-radius: 30px;"><span>{{ __('mail.welcome.action_button') }}</span></a>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                {{-- <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('mail.welcome.icon_one') }}" border="0"  alt="icon"> --}}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                {{-- <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('mail.welcome.icon_two') }}" border="0"  alt="icon"> --}}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                {{-- <img style="display:block;width:100%;max-width:70px;border:0px;"    width="70" src="{{ __('mail.welcome.icon_three') }}" border="0"  alt="icon"> --}}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
                                                    ...
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="center-text" align="left"
                                                                ...
                                                                <div>
                                                                    {{ __('mail.welcome.Headline Three') }}
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="center-text container-padding" align="left"
                                                                ...
                                                                <div>
                                                                    {{ __('mail.welcome.Paragraph Three') }}
                                                                </div>
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <div>
                                            {{ config('mail.welcome.street_address') }}
                                        </div>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <a href="tel:{{ config('mail.welcome.phone_number') }}"
                                           style="color:#6e6e6e;"><span>{{ config('mail.welcome.phone_number') }}</span></a>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <a href="mailto:{{ config('mail.welcome.info_email') }}"
                                           style="color:#6e6e6e;"><span>{{ config('mail.welcome.info_email') }}</span></a> - <a
                                           href="{{ url('/') }}"
                                ...
                                <tr>
                                    <td align="center">
                                        @if (config('mail.welcome.play_url') != '' || config('mail.welcome.ios_url') != '')
                                            <!-- Buttons -->
                                            <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ config('mail.welcome.ios_url') }}"><img
                                                                ...
                                                                <td align="center">
                                                                    <a href="{{ config('mail.welcome.play_url') }}"><img
                                                                             style="display:block;width:100%;max-width:117px;border:0px;"
                                                                             width="117"
